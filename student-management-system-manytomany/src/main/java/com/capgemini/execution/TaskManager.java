...
//		
		...
		projectService.save(project1);   // save project first
//		
...
//		
		...
		student1.setProjects(List.of(project1,project2));
...
//		
		...
		student2.setProjects(List.of(project1,project3));
